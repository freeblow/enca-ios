...
//  test-mac-enca
//
//  Created by freeblow on 2019/3/21.
//  Copyright © 2019 freeblow. All rights reserved.
//

#import <libenca_mac/common.h>
...
//    return err;
    ...
    char *plistPath = "/Users/freeblow/Documents/iZipper/libenca/TestEnca/Info.plist";
    options.language = "zh";
    an = enca_analyser_alloc("zh");
    
    process_file(an, plistPath);
