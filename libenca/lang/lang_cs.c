/*
  encoding data and routines dependent on language; czech
 ...
 **/
const EncaLanguageInfo ENCA_LANGUAGE_CS = {
  "cs",
  "czech",
  NCHARSETS,
  CHARSET_NAMES,
 ...
 *
 * Launches language specific hooks for language "cs".
 *
 ...
 * @analyser: Analyser state whose charset ratings are to be modified.
 *
 * Launches language specific EOL hooks for language "cs".
 *
 * Returns: Nonzero if charset ratigns have been actually modified, zero
 * otherwise.
 **/
 ...
 * @analyser: Analyser state whose charset ratings are to be modified.
 *
 * Decides between iso8859-2 and cp1250 charsets for language "cs".
 *
 * Returns: Nonzero if charset ratigns have been actually modified, zero
 * otherwise.
 **/
 ...
 * @analyser: Analyser state whose charset ratings are to be modified.
 *
 * Decides between ibm852 and keybcs2 charsets for language "cs".
 *
 * Returns: Nonzero if charset ratigns have been actually modified, zero
 * otherwise.
 **/
...
hook_ibmkam(EncaAnalyserState *analyser)
{
  static const unsigned char list_ibm852[] = {
    0xd8, 0xa7, 0xfd, 0xe7, 0x9f, 0xec, 0x85
  };
  static const unsigned char list_keybcs2[] = {
    0x88, 0x91, 0xa9, 0x87, 0xa8, 0x98, 0x96
  };
  static EncaLanguageHookData1CS hookdata[] = {
